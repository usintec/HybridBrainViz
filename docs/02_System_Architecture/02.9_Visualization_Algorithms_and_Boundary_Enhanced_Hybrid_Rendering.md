...
I′<sub>m</sub>(x,y,z) = (I<sub>m</sub>(x,y,z) − I<sub>min</sub>) / (I<sub>max</sub> − I<sub>min</sub>)
...
For each voxel:
$$
P(c \mid x,y,z) = \mathrm{Softmax}(L_c)
$$
The predicted class is:
$$
\hat{y}(x,y,z) = \arg\max_c P(c \mid x,y,z)
$$
The resulting segmentation volume is:
$$
S(x,y,z) \in {0,1,\ldots,C-1}
$$
